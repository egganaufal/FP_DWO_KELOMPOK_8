...
<head>
    ...
    <title>DWOFINAL - Territory</title>
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $sql = "SELECT COUNT(territory_id) as jumlah_territory from territory";
                                                     $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo number_format($row2['jumlah_territory'],0,".",",");
                                                        }
                                                ?>  
                                                </div>
                                        </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Penjualan dari Australia
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                    <?php
                                                    $sql = "SELECT COUNT(f.salesorder_id) salesorder FROM fakta_sales f 
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                Jumlah Produk Berdasarkan Territory "Southwest" pada tahun 2002</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php  
                                            $sql = "SELECT COUNT(p.salesorder_id) as jml_trt1 FROM fakta_sales p
                                                    JOIN territory l ON p.territory_id=l.territory_id
                                                    JOIN time_dimens t ON p.time_id=t.time_id 
                                                    WHERE l.territory_id = 4 and t.year=2004";
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                                                    echo number_format($row2['jml_trt1'],0,".",",");
                                                 }
                                            ?>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body-store">
                                    <div class="chart-area-store">
                                        ...
                                        <?php
                                            ...
                                            $kategori = mysqli_query($mysqli,"SELECT DISTINCT(name), COUNT(fp.salesorder_id) as total 
                                                    FROM fakta_sales fp JOIN territory f ON fp.territory_id = f.territory_id 
                                                    GROUP BY f.name ORDER BY total DESC");
                                            while($row = mysqli_fetch_array($kategori)){
                                                $jenis_kategori[] = $row['name'];

                                                $query = mysqli_query($mysqli,"SELECT COUNT(fp.salesorder_id) as total 
                                                    FROM fakta_sales fp JOIN territory f ON fp.territory_id = f.territory_id

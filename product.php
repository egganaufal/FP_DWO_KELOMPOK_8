...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $mysqli     = mysqli_connect($host, $user, $password, $database);
                                                    ...
                                                    $sql = "SELECT COUNT(product_id) as jumlah_prod from fakta_prd";
                                                    $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo number_format($row2['jumlah_prod'],0,".",",");
                                                        }
                                                ?>  
                                                </div>
                                        </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Produk Tahun 1998</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php  
                                            $sql = "SELECT COUNT(p.product_id) as jml_product FROM fakta_prd p
                                                    JOIN time_dimens t ON p.time_id=t.time_id 
                                                    WHERE t.year=1998";
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                                                    echo number_format($row2['jml_product'],0,".",",");
                                                 }
                                            ?>
                                            </div>
                                        </div>
                        ...
                        <!-- Jumlah Produk Tahun 2002 -->
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Jumlah Produk Berdasarkan Lokasi "Metal Storage" Pada Tahun 2001 - 2003
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                    <?php  
                                                    $sql = "SELECT COUNT(p.product_id) as jml_prd2 FROM fakta_prd p
                                                            JOIN location l ON p.location_id=l.location_id
                                                            JOIN time_dimens t ON p.time_id=t.time_id 
                                                            WHERE l.location_id = 5 and t.year between '2001' and '2003'";
                                                    $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo number_format($row2['jml_prd2'],0,".",",");
                                                        }
                                                    ?>
                                                    </div>
                                                </div>
    ...
    <script type="text/javascript">
        ...
        $bulan = "SELECT CONCAT(MONTHNAME(t.date), ' ', YEAR(t.date)) month FROM fakta_prd f 
                  ...
                  ORDER BY t.date";
        $product = "SELECT COUNT(f.product_id) product FROM fakta_prd f 
                    JOIN time_dimens t ON f.time_id=t.time_id GROUP BY t.month 
                    ORDER BY t.date";
        $i=1;

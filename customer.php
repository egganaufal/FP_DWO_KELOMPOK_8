...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $mysqli     = mysqli_connect($host, $user, $password, $database);
                                                    ...
                                                    $sql = "SELECT COUNT(costumer_id) as jumlah_ct from fakta_sales";
                                                    $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo number_format($row2['jumlah_ct'],0,".",",");
                                                        }
                                                ?>  
                                                </div>
                                        </div>
                        ...
                        <!-- Jumlah Customer Tahun 2001 - 2003 -->
                        <div class="col-xl-3 col-md-6 mb-4">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Customer Tahun 2001 - 2003</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php  
                                            $sql = "SELECT COUNT(p.costumer_id) as jml_ct1 FROM fakta_sales p
                                                    JOIN time_dimens t ON p.time_id=t.time_id 
                                                    WHERE t.year between '2001' and '2003'";
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                                                    echo number_format($row2['jml_ct1'],0,".",",");
                                                 }
                                            ?>
                                            </div>
                                        </div>
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Customer Tahun 2004</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php  
                                            $sql = "SELECT COUNT(c.costumer_id) as jml_ct1 FROM fakta_sales c
                                                    JOIN time_dimens t ON c.time_id=t.time_id 
                                                    WHERE t.year=2004";
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                                                    echo number_format($row2['jml_ct1'],0,".",",");
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Jumlah Product Per Bulan</h6>
    ...
    <script type="text/javascript">
        ...
        $bulan = "SELECT CONCAT(MONTHNAME(t.date), ' ', YEAR(t.date)) month FROM fakta_sales f 
                  ...
                  ORDER BY t.date";
        $product = "SELECT COUNT(s.costumer_id) as costumer FROM fakta_sales s
                    JOIN time_dimens t ON s.time_id=t.time_id 
                    GROUP BY t.month ORDER BY t.year";
        $i=1;

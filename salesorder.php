...
<head>
    ...
    <title>DWOFINAL - Sales Order</title>
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $sql = "SELECT COUNT(salesorder_id) as jumlah_order from fakta_sales";
                                                    $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
                                                            echo number_format($row2['jumlah_order'],0,".",",");
                                                        }
                                                ?>  
                                                </div>
                                        </div>
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Penjualan Berdasarkan Tahun 2003</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                            $sql = "SELECT COUNT(s.salesorder_id) as jml_order1 FROM fakta_sales s
                                                    JOIN time_dimens t ON s.time_id=t.time_id 
                        ...
                        <!-- <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Penjualan dari Australia
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
